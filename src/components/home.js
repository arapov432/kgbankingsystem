...
const topics = [
  ...
  function Resource({match}){
      ...
      return(
          <div>
              <h1>This is Resource Page {topic.name}</h1>
              <h3>Topics description {topic.description}</h3>
  ...
  function Topic({match}){
      ...
      return (
          <div>
              <h1>Here are Topics and description, Resource </h1>
              <h3>{topic.name}</h3>
  ...
  function Topics({match}){
      return(
          <div>
          <h1>This is only topics name here</h1>
          <ul>{topics.map(({name, id})=>(
              <li key={id}>
